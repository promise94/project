...
Sub DelFile( resourceType, currentFolder )
	Dim sdFileName,sErrorNumber
		sdFileName = Request.QueryString( "DelFileName" )
	Dim sServerDir
		sServerDir = ServerMapFolder( resourceType, CombineLocalPaths(currentFolder, sdFileName), "DelFile" )
		
		On Error Resume Next
		
		DelServerFile sServerDir
