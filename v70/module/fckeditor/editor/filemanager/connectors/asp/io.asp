...
Sub DelServerFile( folderPath )
	...
	If  oFSO.FileExists( folderPath )  Then
		On Error resume next
		oFSO.DeleteFile ( folderPath )
		...
		Select Case iErrNumber
			...
			SendError sErrorNumber, "DelServerFile(" & folderPath & ") : " & sErrDescription
		end if
