...
FCKConfig.ToolbarSets["aboveBasic"] = [
	['Source','Bold','Italic','-','FontName','FontSize','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','TextColor','BGColor','-','OrderedList','UnorderedList','Table','-','Link','Unlink','Image']
] ;
