...
<form name="form" id="form" method="post" action="imgtext_save.php">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr class="nb" style="display:none">
			...
			<td class="attrArea"></td>
		</tr>
		<tr class="nb" style="display:none">
			<td colspan="2" height="26"><div class="line"> </div></td>
		</tr>
		<tr class="nb" style="display:none">
			<td colspan="2" height="0" id="df"></td>
		</tr>
		<tr style="display:none">
			<td height="40" align="right">文章来源：</td>
			<td><input type="text" name="source" id="source" class="input" value="" />
		...
		<tr style="display:none">
			...
			<td><input type="text" name="author" id="author" class="input" value="" /></td>
		</tr>
		<tr>
		...
		<tr style="display:none">
			...
			<td><input type="text" name="keywords" id="keywords" class="input" value="" />
		...
		<tr class="nb" style="display:none">
			...
			<td><fieldset class="picarr">
					<legend>列表</legend>
					<div>最多可以上传<strong>50</strong>张图片<span onclick="GetUploadify('uploadify2','组图上传','image','image',50,,'picarr','picarr_area')">开始上传</span></div>
					<ul id="picarr_area">
		...
		<tr style="display:none">
			...
			<td><input type="text" name="hits" id="hits" class="inputos" value="" /></td>
		</tr>
		<tr style="display:none">
			<td height="40" align="right">排列排序：</td>
			<td><input type="text" name="orderid" id="orderid" class="inputos" value="" /></td>
		</tr>
		<tr style="display:none">
			<td height="40" align="right">更新时间：</td>
			<td><input name="posttime" type="text" id="posttime" class="inputms" value="" readonly="readonly" />
