...
class Request
{
     ...
     *
     * Suppose that an index.phtml file instantiates this request object:
     *
     *  * http://localhost/index.phtml         returns an empty string
     *  * http://localhost/index.phtml/page    returns an empty string
     *  * http://localhost/web/index.phtml     returns '/web'
     *  * http://localhost/we%20b/index.phtml  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
     ...
     * script filename (e.g. index.phtml) if one exists.
     *
